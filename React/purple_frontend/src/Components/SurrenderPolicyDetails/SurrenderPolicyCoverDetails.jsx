...
import SurrenderCoverAdd from "../SurrenderCoverDetails/SurrenderCoverAdd";
import SurrenderCoverInfo from "../SurrenderCoverDetails/SurrenderCoverInfo";
...
function SurrenderPolicyCoverDetails({
  open,
  close,
  coverDetails,
  setcoverDetails,
  ...
  const getpolicyCovers = () => {
    axios
      .get(`http://localhost:8090/surrenderCoverPas/get/${id}/${userId}`, {
        headers: {
...
export default SurrenderPolicyCoverDetails;
