...
function SurrenderPolicyDetailsInfo({ open, handleClose, data }) {
  return (
    <div>
        <Modal
        show={open}
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Surrender Policy Details Info</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default SurrenderPolicyDetailsInfo