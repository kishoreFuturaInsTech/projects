                ...
                <Grid container spacing={2}>
                  <Grid item xs={8} md={6} lg={4}>
                    <TextField
                      label="Req Date"
                      id="flcReqDate"
                      value={moment(transData?.flcReqDate).format("DD/MM/YYYY")}
                  ...
                  <Grid item xs={8} md={6} lg={4}>
                    <TextField
                      label="Log Date"
                      id="flcLogDate"
                      value={moment(transData?.flcLogDate).format("DD/MM/YYYY")}
                  ...
                  {policyData?.uinNumber?.includes("L") ? (
                    <Grid item xs={8} md={6} lg={4}>
                      <TextField
                        type="number"
                        label="Total Premium"
                  ...
                  {policyData?.uinNumber?.includes("N") ? (
                    <Grid item xs={8} md={6} lg={4}>
                      <TextField
                        type="number"
                        label="Stamp Duty+GST"
